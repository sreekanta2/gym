...
import { demoMenus } from "../../../config/data";
...
const ShowCase = () => {
  ...
  return (
    <section className="py-16 2xl:py-[100px] bg-default-100" id="demos">
      <div className="container">
        <div className="max-w-[670px] mx-auto">
          ...
          <p className="text-base leading-7 text-center text-default-700">
            Discover Stunning Next.js Demos That Redefine Web Experience
          </p>
        </div>
