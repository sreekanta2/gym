  ...
  ({ className, children, title, childItem, href, ...props }, forwardedRef) => (
    <Link href={href} passHref legacyBehavior>
      <NavigationMenu.Link asChild>
        <a
          className={cn(
            "select-none text-base font-medium   rounded-md flex items-center gap-2 mb-4 last:mb-0 leading-none no-underline outline-none transition-colors hover:text-primary focus:text-primary",
            className
          )}
          ref={forwardedRef}
          {...props}
